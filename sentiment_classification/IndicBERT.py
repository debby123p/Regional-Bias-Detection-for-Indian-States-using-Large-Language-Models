...
# ✅ Load Dataset
file_path = "/home/debasmita/bs_thesis/data/distilled_sbert_classified_comments_threshold_point_4.csv"
df = pd.read_csv(file_path)

# ✅ Load Pretrained IndicBERT Model for Sentiment Analysis
model_name = "ai4bharat/indic-bert"  # Ensure this model supports sequence classification
...
# ✅ Function to Classify Sentiment Using IndicBERT
def classify_sentiment(text):
    try:
        ...
        # ✅ Map IndicBERT Labels to Sentiment Categories
...
# ✅ Save Output
output_path = "/home/debasmita/bs_thesis/data/classified_comments_with_sentiment_indicbert.csv"
df.to_csv(output_path, index=False)

# ✅ Print Summary
print("Sentiment Classification Completed Using IndicBERT.")
