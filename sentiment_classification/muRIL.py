...
# ✅ Load Pretrained MuRIL Model for Sentiment Analysis
model_name = "google/muril-base-cased"  # Ensure this model supports sequence classification
...
# ✅ Function to Classify Sentiment Using MuRIL
def classify_sentiment(text):
    try:
        ...
        # ✅ Map MuRIL Labels to Sentiment Categories
...
# ✅ Save Output
output_path = "/home/debasmita/bs_thesis/data/classified_comments_with_sentiment_muril.csv"
df.to_csv(output_path, index=False)

# ✅ Print Summary
print("Sentiment Classification Completed Using MuRIL.")
