...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler(f"{LOG_DIR}/qwen2.5_7b_150examples_{datetime.now().strftime('%Y%m%d_%H%M%S')}.log"),
...
# Model name for saving files - no change needed as this is just for file naming
MODEL_NAME = "qwen2.5_7b_instruct_150examples"
