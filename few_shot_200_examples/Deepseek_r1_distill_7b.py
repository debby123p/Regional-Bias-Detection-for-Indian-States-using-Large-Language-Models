...
def parse_arguments():
    ...
    parser.add_argument('--output_dir', type=str, 
                        default=os.environ.get('OUTPUT_DIR', 'results/few_shot_200'),
    ...
    for i in range(0, len(test_comments)):
        ...
        try:
            ...
            if output_dir and ((i + 1) % checkpoint_interval == 0 or i == len(test_comments) - 1):
                ...
                model_short_name = "deepseek_7b_200examples"
...
def save_results(test_df, predictions, raw_outputs, output_dir, logger, model_name="deepseek_7b_200examples"):
    """
