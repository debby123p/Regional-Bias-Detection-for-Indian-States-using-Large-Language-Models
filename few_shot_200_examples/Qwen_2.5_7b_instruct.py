...
def parse_arguments():
    ...
    parser.add_argument('--output_dir', type=str, 
                        default=os.environ.get('OUTPUT_DIR', 'results/qwen_few_shot'),
...
def batch_predict(model, tokenizer, test_df, examples_df, device, random_seed=42, 
    ...
    # Process examples individually - Qwen might need specific handling
    for i in range(0, len(test_comments)):
        ...
        try:
            ...
            # Add a brief pause before prediction for better quality with Qwen
            if i > 0 and i % 5 == 0:
            ...
            if output_dir and ((i + 1) % checkpoint_interval == 0 or i == len(test_comments) - 1):
                ...
                model_short_name = "qwen_7b_200examples"
...
def save_results(test_df, predictions, raw_outputs, output_dir, logger, model_name="qwen_7b_200examples"):
    """
