...
def parse_args():
    ...
    parser = argparse.ArgumentParser(
        description='Zero-shot binary classification for regional bias detection using Mistral models with memory optimization')
...
def setup_environment(args):
    ...
    # Create log directory (or use output_dir)
...
class RegionalBiasClassifier:
    def __init__(self, model_name="mistralai/Mistral-7B-Instruct-v0.3", 
        ...
        Args:
            ...
            max_gpu_memory: Maximum GPU memory to use (e.g., "16GB")
        ...
        try:
            ...
            with torch.no_grad():
                try:
                    ...
                    # Emergency fallback: try with reduced parameters
...
def save_iteration_results(iteration_results, output_dir, iteration_num, timestamp, prefix="mistral"):
    ...
    Args:
        ...
        prefix: Model name prefix for file naming (default: "mistral")
    ...
    try:
        ...
        try:
            if args.hf_token:
                ...
                logger.info("Successfully logged in to HuggingFace with provided token")
            elif os.environ.get("HF_TOKEN"):
                login(token=os.environ["HF_TOKEN"])
                logger.info("Successfully logged in to HuggingFace using environment token")
        except Exception as e:
            logger.warning(f"Warning: Could not log in to HuggingFace: {e}")
...
if __name__ == "__main__":
    ...
    # Run classification
    print("Starting regional bias classification with Mistral model...")
    main()
