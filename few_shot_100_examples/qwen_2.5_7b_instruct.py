...
DEFAULT_GPU_ID = 0  # This script uses GPU 0 by default
...
def predict_with_model(model, tokenizer, prompt, device, max_length=4096, max_tokens=10, logger=None):
    ...
    try:
        ...
        # Generate response - Qwen specific generation parameters
        with torch.no_grad():
            outputs = model.generate(
                **inputs,
                ...
                num_beams=1,      # Simple greedy decoding for Qwen with 100 examples
