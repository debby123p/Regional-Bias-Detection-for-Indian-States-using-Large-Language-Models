...
# ✅ Function to handle long comments using a sliding window
def assign_sentiment_score(comment):
    try:
        ...
        # ✅ Assign sentiment category directly (Positive, Negative, Other)
        if sentiment_label == "LABEL_2":  # Positive sentiment
            return "Positive", sentiment_score
        elif sentiment_label == "LABEL_0":  # Negative sentiment
            return "Negative", sentiment_score
        else:
            return "Other", sentiment_score  # Previously Neutral, now categorized as "Other"

    except Exception as e:
        return "Other", 0.0  # Default to Other if there's an error
...
output_file_path = "/home/debasmita/bs_thesis/data/classified_comments_with_xlm_roberta_sentiment.csv"
